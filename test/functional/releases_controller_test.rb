...
class ReleasesControllerTest < ActionController::TestCase
  ...
  test "should create release" do
    assert_difference('Release.count') do
      post :create, release: { cover_url: @release.cover_url, description: @release.description, title: @release.title }
    end
  ...
  test "should update release" do
    put :update, id: @release, release: { cover_url: @release.cover_url, description: @release.description, title: @release.title }
    assert_redirected_to release_path(assigns(:release))
  end
